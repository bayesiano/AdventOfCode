...
object Problem20a {
    ...
    fun main(args: Array<String>) {
        println(solve( "day20/example.txt"))
        println(solve( "day20/input.txt"))
    }
    ...
    fun solve( filename: String): Int {
        ...
        //println( image.size)
        //println()
        val image1 = enhanceImage( image, config, 0)
        //printImage( image1)
        //println( image1.size)
        //println()
        val image2 = enhanceImage( image1, config, if(config[0] == '.') 0 else 1)
        //printImage( image2)
        //println( image2.size)
        //println()
        return image2.size
